	...
	public static class PagingToolBarImages {
		...
		public PagingToolBarImages()
		{
			if(GXT.isHighContrastMode)
			{
				...
				if(isRTL)
				{
					last = IconHelper.create("gxt/themes/access/images/grid/page-first.gif");
					first = IconHelper.create("gxt/themes/access/images/grid/page-last.gif");
					prev = IconHelper.create("gxt/themes/access/images/grid/page-next.gif");
					next = IconHelper.create("gxt/themes/access/images/grid/page-prev.gif");
				}else
				{
					first = IconHelper.create("gxt/themes/access/images/grid/page-first.gif");
					last = IconHelper.create("gxt/themes/access/images/grid/page-last.gif");
					next = IconHelper.create("gxt/themes/access/images/grid/page-next.gif");
					prev = IconHelper.create("gxt/themes/access/images/grid/page-prev.gif");
				}
			}else
			{
			...
			refresh = GXT.isHighContrastMode
			? IconHelper.create("gxt/themes/access/images/grid/refresh.gif") : AbstractImagePrototype.create(GXT.IMAGES.paging_toolbar_refresh());
		}
