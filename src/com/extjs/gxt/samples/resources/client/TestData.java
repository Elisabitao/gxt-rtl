...
public class TestData {
  ...
  public static List<Stock> getCompanies() {
	  List<Stock> stocks = new ArrayList<Stock>();
	    stocks.add(new Stock("3m Co", 71.72, 0.02, 0.03, new Date(),
	        "Manufacturing"));
	    stocks.add(new Stock("Alcoa Inc", 29.01, 0.42, 1.47, new Date(),
	        "Manufacturing"));
	    stocks.add(new Stock("Altria Group Inc", 83.81, 0.28, 0.34, new Date(),
	        "Manufacturing"));
	    ...
	    stocks.add(new Stock("American International Group, Inc.", 64.13, 0.31, 0.49,
	        new Date(), "Services"));
	    stocks.add(new Stock("AT&T Inc.", 31.61, -0.48, -1.54, new Date(),
	        "Services"));
	    stocks.add(new Stock("Boeing Co.", 75.43, 0.53, 0.71, new Date(),
	        "Manufacturing"));
	    stocks.add(new Stock("Caterpillar Inc.", 67.27, 0.92, 1.39, new Date(),
	        "Services"));
	    stocks.add(new Stock("Citigroup, Inc.", 49.37, 0.02, 0.04, new Date(),
	        "Finance"));
	    stocks.add(new Stock("E.I. du Pont de Nemours and Company", 40.48, 0.51, 1.28,
	        new Date(), "Manufacturing"));
	    stocks.add(new Stock("Exxon Mobil Corp", 68.1, -0.43, -0.64, new Date(),
	        "Manufacturing"));
	    ...
	    stocks.add(new Stock("Hewlett-Packard Co.", 36.53, -0.03, -0.08,
	        new Date(), "Computer"));
	    stocks.add(new Stock("Honeywell Intl Inc", 38.77, 0.05, 0.13, new Date(),
	        "Manufacturing"));
	    stocks.add(new Stock("Intel Corporation", 19.88, 0.31, 1.58, new Date(),
	        "Computer"));
	    stocks.add(new Stock("International Business Machines", 81.41, 0.44, 0.54,
	        new Date(), "Computer"));
	    stocks.add(new Stock("Johnson & Johnson", 64.72, 0.06, 0.09, new Date(),
	        "Medical"));
	    stocks.add(new Stock("JP Morgan & Chase & Co", 45.73, 0.07, 0.15,
	        new Date(), "Finance"));
	    stocks.add(new Stock("McDonald\"s Corporation", 36.76, 0.86, 2.40,
	        new Date(), "Food"));
	    stocks.add(new Stock("Merck & Co., Inc.", 40.96, 0.41, 1.01, new Date(),
	        "Medical"));
	    stocks.add(new Stock("Microsoft Corporation", 25.84, 0.14, 0.54,
	        new Date(), "Computer"));
	    stocks.add(new Stock("Pfizer Inc", 27.96, 0.4, 1.45, new Date(),
	        "Services"));
